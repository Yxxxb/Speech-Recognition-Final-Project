...
from decoders_text.ctc_greedy_decoder import greedy_decoder
...
class Predictor:
    def __init__(self, model_dir, audio_process, decoding_method='ctc_greedy', alpha=1.2, beta=0.35,
        ...
        if decoding_method == "ctc_beam_search":
            try:
                from decoders_text.beam_search_decoder import BeamSearchDecoder
        ...
        # 预热
        warmup_audio_path = 'test_data/test.wav'
